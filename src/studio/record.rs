...
mod tests {
    ...
    fn links_resolve_relative_parents_anchors_and_ignore_scheme_targets() {
        let body = "[a](../game/domain.md#activity) [b](#local) [c](https://example.test/x) [d](items/one.md) [e](./two.md)\n";
        let link = links(body, 1, "docs/concept/discovery.md");
        let resolved = link
            .iter()
        ...
        assert_eq!(
            ...
            vec![
                LinkTarget::Repository {
                    path: "docs/game/domain.md".to_owned(),
                ...
                LinkTarget::External,
                LinkTarget::Repository {
                    path: "docs/concept/items/one.md".to_owned(),
                    anchor: None
                },
                LinkTarget::Repository {
                    path: "docs/concept/two.md".to_owned(),
                    anchor: None
                },
            ]
        );
    ...
    fn fixture(name: &str) -> PathBuf {
        let root = crate::studio::test_directory(name);
        write(
            &root,
            "docs/README.md",
    ...
    fn a_clean_fixture_repository_lints_without_findings() {
        ...
        assert_eq!(
            repository
                .get("docs/concept/discovery.md")
                .expect("record")
                .title,
            "Discovery"
        );
        assert_eq!(
            repository.backlink("docs/concept/discovery.md")[0].path,
            "docs/concept/README.md"
        );
    }
    ...
    fn each_lint_rule_names_the_offending_file() {
        ...
        write(&root, "docs/stray.md", "# Stray\n");
        write(
            &root,
            "docs/concept/knowledge.md",
            "---\nstatus: unknown-value\n---\n\n# Knowledge\n\n[gone](missing.md)\n[bad anchor](discovery.md#nowhere)\n",
        );
        write(
            &root,
            "docs/concept/spatial.md",
        ...
        assert_eq!(by_rule(RULE_UNMATCHED), vec!["docs/stray.md"]);
        assert_eq!(by_rule(RULE_ROLE_HEADER), vec!["docs/concept/knowledge.md"]);
        assert_eq!(by_rule(RULE_LINK), vec!["docs/concept/knowledge.md"]);
        assert_eq!(by_rule(RULE_ANCHOR), vec!["docs/concept/knowledge.md"]);
        assert_eq!(
            by_rule(RULE_FRONT_MATTER),
            vec!["docs/concept/knowledge.md", "docs/concept/spatial.md"]
        );
        assert_eq!(
    ...
    fn front_matter_references_are_checked_as_root_relative_repository_paths() {
        ...
        let root = crate::studio::test_directory("record-informs");
        write(
            &root,
            "docs/README.md",
            "# Constitution\n\n> **Role / side:** placement constitution / development side.\n> **Authority:** placement.\n",
        ...
        write(
            &root,
            "lab/multiplayer/01-good/README.md",
            &experiment(
                ".agents/plans/20260816-lab/plan.md#t3--prove-one-unified-semantic-change-kernel",
            ),
        );
        write(
            &root,
            "lab/multiplayer/02-bad-anchor/README.md",
            &experiment(
                ".agents/plans/20260816-lab/plan.md#t3-prove-one-unified-semantic-change-kernel",
            ),
        );
        write(
            &root,
            "lab/multiplayer/03-missing-file/README.md",
            &experiment(".agents/plans/20260816-gone/plan.md#t3"),
        );
        ...
        assert_eq!(
            ...
            vec![
                (
                    ".agents/plans/20260817-orphan/plan.md".to_owned(),
                    Some(7),
                    RULE_LINK,
                    "front-matter `backlog_item` names missing `.agents/backlog/items/gone.md`"
                        .to_owned()
                ),
                (
                    "lab/multiplayer/02-bad-anchor/README.md".to_owned(),
                    Some(7),
                    RULE_ANCHOR,
                    "front-matter `informs` `#t3-prove-one-unified-semantic-change-kernel` is not a heading of `.agents/plans/20260816-lab/plan.md`".to_owned()
                ),
                (
                    "lab/multiplayer/03-missing-file/README.md".to_owned(),
                    Some(7),
                    RULE_LINK,
                    "front-matter `informs` names missing `.agents/plans/20260816-gone/plan.md`".to_owned()
                ),
            ],
    ...
    fn frozen_homes_are_excluded_from_link_and_metadata_sweeps() {
        ...
        write(
            &root,
            "docs/concept/archive/00-vision.md",
            "> **Archived:** old.\n\n# Vision\n\n[gone](missing.md)\n",
        );
        write(
            &root,
            ".agents/plans/20260810-a/plan.md",
            "---\nstatus: complete\ncreated_at: \"2026-08-10T15:58:46+02:00\"\nlegacy_key: x\n---\n\n# Complete plan\n\n[gone](missing.md)\n",
        );
        write(
            &root,
            ".agents/plans/20260810-a/move-map/t2.md",
            "# Fragment\n\n[gone](missing.md)\n",
        );
        write(
            &root,
            ".agents/plans/20260816-b/plan.md",
            "---\nstatus: draft\ncreated_at: \"2026-08-16T15:34:10+02:00\"\nupdated_at: \"2026-08-17T11:47:38+02:00\"\naccepted_at: null\ncompleted_at: null\n---\n\n# Draft plan\n\n> **Role / side:** proportional build plan / development side.\n> **Authority:** execution state.\n\n[gone](missing.md)\n",
        );
        write(
            &root,
            ".agents/plans/20260811-c/plan.md",
        ...
        assert!(
            finding.iter().all(
                |finding| !finding.path.starts_with(".agents/plans/20260810-a")
                    && !finding.path.starts_with(".agents/plans/20260811-c")
                    && !finding.path.starts_with("docs/concept/archive")
            ),
            "frozen records must not be linted: {finding:?}"
        );
        assert!(
            repository
                .get(".agents/plans/20260811-c/plan.md")
        ...
        assert_eq!(
            finding
                .iter()
                .filter(|finding| finding.path == ".agents/plans/20260816-b/plan.md")
    ...
    fn a_decision_register_keeps_metadata_lint_but_loses_link_lint() {
        ...
        let rule = repository
            .lint()
            .into_iter()
            .filter(|finding| finding.path == "docs/concept/log/2026-08.md")
            .map(|finding| finding.rule)
            .collect::<Vec<_>>();
