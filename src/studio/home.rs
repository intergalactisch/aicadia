...
const GOVERNED_DIRECTORY: [&str; 5] = ["docs", ".agents", "lab", "src/agent_contract", "migration"];

/// Governed records that are not inside a governed directory.
const GOVERNED_FILE: [&str; 3] = ["AGENTS.md", "CLAUDE.md", "CONTEXT.md"];
...
impl Rule {
    fn matches(self, path: &str) -> bool {
        match self {
            ...
            Self::MonthlyLog => {
                matches_depth(path, "docs/concept/log", 0) && is_month_file(file_name(path))
            }
            Self::Migration => {
                matches_depth(path, "migration", 0) && is_migration_file(file_name(path))
            }
        }
    }
}
...
pub static HOME: &[Home] = &[
    Home {
        ...
        rule: Rule::Exact("docs/README.md"),
        frozen: Frozen::No,
    ...
    Home {
        id: "game-index",
        side: Side::Runtime,
        rule: Rule::Exact("docs/game/README.md"),
        frozen: Frozen::No,
        role_header: RoleHeaderRule::Required,
        vocabulary: Vocabulary::None,
        index: Index::None,
    ...
    Home {
        id: "concept-index",
        side: Side::Development,
        rule: Rule::Exact("docs/concept/README.md"),
        frozen: Frozen::No,
        role_header: RoleHeaderRule::Required,
        vocabulary: Vocabulary::None,
        index: Index::None,
    ...
    Home {
        ...
        side: Side::Development,
        rule: Rule::Exact("docs/concept/log/README.md"),
        frozen: Frozen::No,
        role_header: RoleHeaderRule::Required,
        vocabulary: Vocabulary::None,
        index: Index::None,
    ...
    Home {
        ...
        index: Index::Fixed("docs/concept/README.md"),
    },
    Home {
        id: "research-index",
        side: Side::Development,
        rule: Rule::Exact("docs/research/README.md"),
        frozen: Frozen::No,
        role_header: RoleHeaderRule::Required,
        vocabulary: Vocabulary::None,
        index: Index::None,
    ...
    Home {
        ...
        index: Index::Fixed("docs/research/README.md"),
    },
    Home {
        id: "evidence-index",
        side: Side::Bridge,
        rule: Rule::Exact("docs/evidence/README.md"),
        frozen: Frozen::No,
        role_header: RoleHeaderRule::Required,
        vocabulary: Vocabulary::None,
        index: Index::None,
    ...
    Home {
        ...
        index: Index::Fixed("docs/evidence/README.md"),
    },
    Home {
        id: "backlog-index",
        side: Side::Development,
        rule: Rule::Exact(".agents/backlog/README.md"),
        frozen: Frozen::No,
        role_header: RoleHeaderRule::Required,
        vocabulary: Vocabulary::None,
        index: Index::None,
    ...
    Home {
        id: "capability-map",
        side: Side::Development,
        rule: Rule::Exact(".agents/backlog/capability-map.md"),
        frozen: Frozen::No,
        role_header: RoleHeaderRule::Required,
        vocabulary: Vocabulary::None,
        index: Index::None,
    ...
    Home {
        ...
        index: Index::Fixed("lab/README.md"),
    },
    Home {
        id: "lab-record",
        side: Side::Development,
        rule: Rule::Subtree { prefix: "lab" },
        frozen: Frozen::No,
        role_header: RoleHeaderRule::Required,
        vocabulary: Vocabulary::None,
        index: Index::None,
    ...
    Home {
        ...
        side: Side::Runtime,
        rule: Rule::Exact("src/agent_contract/README.md"),
        frozen: Frozen::No,
        role_header: RoleHeaderRule::Required,
        vocabulary: Vocabulary::None,
        index: Index::None,
    ...
    Home {
        ...
        side: Side::Runtime,
        rule: Rule::Leaf {
            prefix: "src/agent_contract/instruction",
            depth: 0,
        },
        frozen: Frozen::No,
        role_header: RoleHeaderRule::Optional,
    ...
    Home {
        ...
        side: Side::Runtime,
        rule: Rule::Leaf {
            prefix: "src/agent_contract/tool",
            depth: 0,
        },
        frozen: Frozen::No,
        role_header: RoleHeaderRule::Optional,
...
/// Studio reads governed Markdown everywhere and SQL only under `migration/`.
fn is_governed_record(path: &str) -> bool {
    path.ends_with(".md") || (path.starts_with("migration/") && path.ends_with(".sql"))
}
...
mod tests {
    ...
    fn the_most_specific_home_wins_over_its_parent_pattern() {
        assert_eq!(id("docs/game/README.md"), Some("game-index"));
        assert_eq!(id("docs/game/domain.md"), Some("game-contract"));
        assert_eq!(id("docs/game/model/entity/README.md"), Some("model"));
        assert_eq!(id("docs/game/model/entity/value.md"), Some("model-concern"));
        assert_eq!(id("docs/game/capability/get_world.md"), Some("capability"));
        assert_eq!(id("docs/concept/README.md"), Some("concept-index"));
        assert_eq!(id("docs/concept/discovery.md"), Some("concept-record"));
        assert_eq!(id("docs/concept/log/README.md"), Some("concept-log-index"));
        assert_eq!(id("docs/concept/log/2026-08.md"), Some("decision-register"));
        assert_eq!(
            id("docs/concept/archive/00-vision.md"),
            Some("concept-archive")
        );
        assert_eq!(id("docs/research/archive/x.md"), Some("research-archive"));
        assert_eq!(
            id("docs/research/world-momentum.md"),
            Some("research-report")
        );
        assert_eq!(id("docs/evidence/README.md"), Some("evidence-index"));
        assert_eq!(id("docs/evidence/trait.md"), Some("evidence-slice"));
        assert_eq!(
            id("docs/evidence/runner/trait-playtest.md"),
            Some("runner-contract")
        );
        assert_eq!(id(".agents/backlog/README.md"), Some("backlog-index"));
        assert_eq!(
            id(".agents/backlog/capability-map.md"),
            Some("capability-map")
        );
        assert_eq!(id(".agents/backlog/items/x.md"), Some("backlog-item"));
        assert_eq!(id(".agents/plans/20260817-x/plan.md"), Some("plan"));
        assert_eq!(
            id(".agents/plans/20260817-x/move-map/t2.md"),
            Some("plan-fragment")
        );
        assert_eq!(id(".agents/skills/build-aicadia/SKILL.md"), Some("skill"));
        assert_eq!(
            id(".agents/skills/build-aicadia/assets/plan-template.md"),
            Some("skill-asset")
        );
        assert_eq!(id("lab/README.md"), Some("lab-index"));
        assert_eq!(id("lab/multiplayer/README.md"), Some("lab-track"));
        assert_eq!(id("lab/multiplayer/01-a/README.md"), Some("lab-experiment"));
        assert_eq!(id("lab/multiplayer/scenarios.md"), Some("lab-record"));
        assert_eq!(id("lab/multiplayer/01-a/note.md"), Some("lab-record"));
        assert_eq!(
            id("src/agent_contract/README.md"),
            Some("agent-contract-index")
        );
        assert_eq!(
            id("src/agent_contract/instruction/00-contract.md"),
            Some("agent-instruction")
        );
        assert_eq!(
            id("src/agent_contract/tool/get_world.md"),
            Some("agent-tool-text")
        );
        assert_eq!(id("migration/0001_world.sql"), Some("migration"));
        assert_eq!(id("docs/README.md"), Some("constitution"));
        assert_eq!(id("AGENTS.md"), Some("build-constitution"));
        assert_eq!(id("CLAUDE.md"), Some("entry-pointer"));
        assert_eq!(id("CONTEXT.md"), Some("vocabulary"));
    }

    #[test]
    fn markdown_without_a_home_stays_unmatched() {
        assert_eq!(id("docs/stray.md"), None);
        assert_eq!(id("docs/game/model/entity/nested/deep.md"), None);
        assert_eq!(id("docs/concept/log/notes.md"), None);
        assert_eq!(id("migration/notes.sql"), None);
        assert_eq!(id("web/studio.js"), None);
    }
    ...
    fn scanning_a_temporary_root_reports_unmatched_markdown_and_skips_target() {
        let root = crate::studio::test_directory("home-scan");
        std::fs::create_dir_all(root.join("docs/game/model/entity")).expect("model directory");
        std::fs::create_dir_all(root.join("docs/target")).expect("target directory");
        std::fs::write(root.join("AGENTS.md"), "# A\n").expect("build constitution");
        std::fs::write(root.join("docs/README.md"), "# C\n").expect("constitution");
        std::fs::write(root.join("docs/stray.md"), "# S\n").expect("stray record");
        std::fs::write(root.join("docs/game/model/entity/README.md"), "# E\n").expect("model");
        std::fs::write(root.join("docs/target/ignored.md"), "# I\n").expect("skipped record");
        ...
        assert!(
            scanned
                .iter()
                .any(|record| record.path == "docs/stray.md" && record.home.is_none())
        );
    }

    #[test]
    fn a_file_over_the_read_bound_is_an_explicit_error() {
        let root = crate::studio::test_directory("home-bound");
        std::fs::create_dir_all(root.join("docs")).expect("docs directory");
        std::fs::write(
