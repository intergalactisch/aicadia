...
pub fn horizon(repository: &Repository) -> Vec<HorizonRow> {
    let Some(record) = repository.get(".agents/backlog/README.md") else {
        return Vec::new();
    };
...
mod tests {
    ...
    fn repository(file: &[(&str, &str)]) -> Repository {
        let root = crate::studio::test_directory("plan-fixture");
    ...
    fn a_plan_projects_front_matter_task_graph_and_open_questions() {
        ...
        assert_eq!(
            ...
            Some(".agents/backlog/items/studio.md")
        );
        assert_eq!(
            plan.task,
            vec![
                Task {
                    ...
                    owned_surface: "`src/studio/`".to_owned(),
        ...
        assert_eq!(
            ...
            vec![
                HorizonRow {
                    ...
                    item_path: Some(".agents/backlog/items/local.md".to_owned()),
                    state: "Done".to_owned(),
    ...
    fn open_sections_come_from_live_concept_records_live_plans_and_backlog_items() {
        let repository = repository(&[
            (".agents/plans/20260817-studio/plan.md", PLAN),
            (
                ".agents/plans/20260810-old/plan.md",
                "---\nstatus: complete\n---\n\n# Old\n\n### Open questions\n\nStale.\n",
            ),
            (
