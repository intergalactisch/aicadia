//! The append-only decision register parsed from `docs/concept/log/YYYY-MM.md`.
...
mod tests {
    ...
    fn register(body: &str) -> Register {
        let root = crate::studio::test_directory("register-fixture");
        let path = root.join("docs/concept/log");
