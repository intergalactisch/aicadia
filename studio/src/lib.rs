...
pub fn app(world: World, pool: PgPool) -> Router {
    ...
    Router::new()
        ...
        .route("/development/direction", get(page::development_direction))
        .route("/development/decision", get(page::development_decision))
        .route("/development/open", get(page::development_open))
        .route("/development/research", get(page::development_research))
        .route("/development/work", get(page::development_work))
        .route("/development/lab", get(page::development_lab))
        .route("/development/evidence", get(page::development_evidence))
        .route("/development/rules", get(page::development_rules))
