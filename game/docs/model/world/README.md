...
> **Excludes:** subject state, Activity meaning, value validation and delivery status; see the other model contracts and `dev/docs/evidence/`.

The concrete `World` type is the only public game-behavior seam. The nineteen player
