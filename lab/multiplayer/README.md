...
> **Excludes:** each experiment's own verdict, status and seams, which live in its front matter; accepted multiplayer game behavior, production architecture and sourced research conclusions; see `docs/game/`, accepted plans and `docs/research/`.
