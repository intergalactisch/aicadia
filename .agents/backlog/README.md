...
| Done | [Current Property and Trait live validation](items/current-property-trait-live-validation.md) | Done | Delivery history and current status: see [Property evidence](../../docs/evidence/property.md) and [Trait evidence](../../docs/evidence/trait.md). |
