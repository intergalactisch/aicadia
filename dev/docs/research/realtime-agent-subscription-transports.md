...
could still use SSE.
[Aicadia MCP handler](../../../game/src/server/mcp.rs),
[Aicadia server transport](../../../game/src/server/mod.rs),
...
[Aicadia server transport](../../../game/src/server/mod.rs),
[protocol request context](../../../game/docs/protocol.md#request-context)
