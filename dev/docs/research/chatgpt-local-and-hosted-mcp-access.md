...
The current `game/tools/aicadia-agent` already passes the command-line flag. This
...
- `./game/tools/aicadia-agent` enables `mcp_2026_07_28`, requires Aicadia MCP, injects
...
These facts come from [Local play](../../../game/docs/local-play.md),
[Agent play contract](../../../game/docs/agent.md),
[the local player adapter](../../../game/tools/aicadia-agent),
[the MCP server implementation](../../../game/src/server/mcp.rs) and
...
The current `game/tools/aicadia-agent` remains the strongest oracle for the latter.
...
|---|---:|---:|---:|---|
| Existing isolated `game/tools/aicadia-agent` | Yes | Yes | Development oracle | Keep |
...
- [Aicadia Agent play contract](../../../game/docs/agent.md)
- [Aicadia local play](../../../game/docs/local-play.md)
- [Aicadia local Codex adapter](../../../game/tools/aicadia-agent)
- [Aicadia current MCP Agent guidance](current-mcp-agent-guidance.md)
- [Aicadia server implementation](../../../game/src/server/mod.rs)
