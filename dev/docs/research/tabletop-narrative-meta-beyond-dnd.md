...
the next Aicadia edge or authorize changes to `game/docs/`.

## Aicadia boundary used for the comparison

The [current build contract](../../../game/docs/README.md) has one persistent World, zero or
...
The [Agent play contract](../../../game/docs/agent.md) adds a separate private layer.
...
The [backlog](../../../dev/backlog/README.md) lists a first investigation roll and
