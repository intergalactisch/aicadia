...
[Agent play contract](../../../game/docs/agent.md#agent-guidance-and-player-facing-communication)
and its
[private-workshop action flow](../../../game/docs/agent.md#required-private-workshop-action-flow).
...
not alter `game/docs/`, authorize new capabilities, or settle future domain models.
