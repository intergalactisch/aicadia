...
contract](../../../game/docs/README.md) owns their concrete executable representation; this
...
log](log/2026-08.md). The [game contract](../../../game/docs/README.md) owns all current fields,
limits, errors, ordering and adapter behavior; the [completed build
plan](../../../dev/plans/20260814-204007-first-investigation-discovery-loop/plan.md)
...
evaluation. The [game contract](../../../game/docs/README.md) owns the current rules. The
...
interface. It changes neither `game/docs/` nor the executable MVP. A game decision
