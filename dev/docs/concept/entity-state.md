...
> **Excludes:** Current behavior and storage, which belong in `game/docs/`; delivery detail, which belongs in `dev/docs/evidence/`.
...
`game/docs/` owns current behavior.
...
Current Property/Trait behavior, validation and persistence are defined by the [Property](../../../game/docs/model/property/README.md) and [Trait](../../../game/docs/model/trait/README.md) model contracts, [capability contracts](../../../game/docs/README.md#capability-contracts) and [storage contract](../../../game/docs/storage.md). This concept record does not duplicate their delivery detail.
...
The completed [uniform-state plan](../../../dev/plans/20260814-232147-uniform-entity-state-packages/plan.md)
