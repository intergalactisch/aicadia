...
Current delivered Action and Interaction semantics, cardinality, target roles, contextual reads and Activity storage live in [the capability contracts](../../../game/docs/README.md#capability-contracts). This record does not restate them.
