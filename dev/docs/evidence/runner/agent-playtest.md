...
> **Excludes:** game-contract rules and delivery status; see `game/docs/` and the slice records in `dev/docs/evidence/`.
...
Every public run remains under `dev/.playtest/agent/`. Its private manifest correlates
