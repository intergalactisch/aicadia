...
and the active
[`concurrency-and-world-dynamics`](../../../../dev/docs/concept/concurrency-and-world-dynamics.md)
...
DATABASE_URL=postgres://localhost/postgres \
  cargo test \
  --manifest-path dev/lab/multiplayer/04-postgres-conflict-strategies/Cargo.toml \
  -- --test-threads=1
```
