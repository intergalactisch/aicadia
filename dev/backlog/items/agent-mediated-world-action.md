...
`dev/plans/20260811-124550-first-agent-mediated-world-action/plan.md`. Current
behavior and the Agent contract are authoritative in `game/docs/README.md` and
`game/docs/agent.md`; the static evidence pointer is under Completion evidence.
...
`dev/docs/research/idempotent-action-delivery-and-place-freshness.md`. The first slice
...
Delivery history and current status: see [Action evidence](../../../dev/docs/evidence/action.md).
