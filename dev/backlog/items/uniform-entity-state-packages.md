...
> **Excludes:** current executable behavior and detailed rationale/evidence; see `game/docs/`, `dev/docs/concept/entity-state.md` and `dev/docs/evidence/`.
...
[Entity-state rationale](../../../dev/docs/concept/entity-state.md#accepted-uniform-state-edge)
owns why the prior homogeneous boundary evolved. The
[uniform Entity-state evidence](../../../dev/docs/evidence/entity-state.md) owns the
delivered proof.
...
[uniform Entity-state evidence](../../../dev/docs/evidence/entity-state.md).
