...
`game/docs/domain.md`, `game/docs/model/` and `game/docs/agent.md`.
...
Delivery history and current status: see [World-entry evidence](../../../dev/docs/evidence/world-entry.md).
