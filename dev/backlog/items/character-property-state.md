...
[`dev/docs/concept/entity-state.md`](../../../dev/docs/concept/entity-state.md).
The executable contract is published in [`game/docs/`](../../../game/docs/README.md).
...
[Property evidence](../../../dev/docs/evidence/property.md) and
