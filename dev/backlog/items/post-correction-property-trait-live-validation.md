...
> **Excludes:** game behavior, detailed spend boundary and evidence history; see `game/docs/`, the linked plan and `dev/docs/evidence/`.
...
[Trait evidence](../../../dev/docs/evidence/trait.md).
