...
`dev/plans/20260813-114241-character-grounded-interaction-history/plan.md`.
The executable contract is in `game/docs/README.md` and
`game/docs/agent.md`. Confirmed design rationale is recorded in
`dev/docs/concept/interaction.md` and `dev/docs/concept/knowledge.md`.
...
`dev/docs/concept/entity-state.md`. They may use separate tables and
...
Delivery history and current status: see [Interaction evidence](../../../dev/docs/evidence/interaction.md).
