...
> **Excludes:** executable behavior and detailed evidence; see `game/docs/`, the build plan and `dev/docs/evidence/`.
...
[Entity-state evidence](../../../dev/docs/evidence/entity-state.md#sol-medium-smoke-result).
