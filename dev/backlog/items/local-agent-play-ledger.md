...
`dev/plans/20260812-091744-agent-only-local-play-ledger/plan.md`; its ledger
surface was absorbed by the accepted Studio plan
`dev/plans/20260817-140952-aicadia-studio-prototype/plan.md` and unified through
`dev/plans/20260817-152535-unified-aicadia-studio/plan.md`. The completed
convention-driven development-environment expansion is recorded in
`dev/plans/20260817-161615-studio-development-environment/plan.md`. The governing
contract is [the current build contract](../../../game/docs/README.md),
[Agent play contract](../../../game/docs/agent.md) and
[Local play](../../../game/docs/local-play.md).
...
- World, PostgreSQL, MCP and player-capability HTTP behavior remains unchanged; the
  former Studio-only global Entity GETs are absent from game HTTP and no new game
  capability is added;
- no build or validation step automatically spends model tokens.

## Current boundary

Delivery history and current status: see [Local-play evidence](../../../dev/docs/evidence/local-play.md).
