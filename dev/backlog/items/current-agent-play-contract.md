...
`dev/plans/20260812-161148-current-agent-play-contract/plan.md`. Current behavior
is governed by [Agent play contract](../../../game/docs/agent.md); the protocol
evidence and limitations are recorded in
[Current MCP Agent guidance](../../../dev/docs/research/current-mcp-agent-guidance.md).
...
Delivery history and current status: see [Agent contract evidence](../../../dev/docs/evidence/agent-contract.md).
