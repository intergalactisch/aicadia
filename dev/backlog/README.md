...
| Now | [Direct spatial exploration S1](../plans/20260820-071639-spatial-exploration-system/plan.md) | Active | Implement the accepted direct Position, bounded shared Place and Connection reads, Position-grounded Entity or connected-Place Discovery and complete or partial Character Movement through World, PostgreSQL, HTTP and MCP. Discovery never moves the Character; Connections use stable identity without endpoint deduplication; Observation, distributed entry, relative Position, Area, Relation and private arrangement remain separately gated later slices. |
