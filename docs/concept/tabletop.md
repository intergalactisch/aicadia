...
> **Authority:** cross-cutting product heuristics and the non-import boundary
> **Excludes:** A borrowed tabletop ruleset or executable mechanics.
...
No tabletop-specific mechanic is accepted by this record. Any future import must be earned by one concrete behavior while preserving the non-import boundary above.
