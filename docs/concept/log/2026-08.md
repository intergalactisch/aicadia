...
- rejected generic executable Relation/Effect / causality needs a mechanical
  ...
  terms remain unaccepted and `docs/game/`/`CONTEXT.md` are unchanged.
- rejected mechanism-first causal architecture / reset to a flat game model: the
  ...
  `docs/game/`, `CONTEXT.md` and code remain unchanged.
...
- selected prototype-first method: build a quick, visibly throwaway, source-backed
  ...
  [prototype plan](../../../.agents/plans/20260817-140952-aicadia-studio-prototype/plan.md).
...
- **Evidence:** the completed Studio plan and `docs/evidence/local-play.md` record
...
- **Affected scope:** `src/studio/`, `web/`, the local Studio operation contract,
...
- **Status:** accepted; implementation active.
- **Choice:** accept
  `.agents/plans/20260817-152535-unified-aicadia-studio/plan.md` as the bounded build
...
- proposed / development environment: on 2026-08-17 the User found that the
  ...
  `.agents/plans/20260817-161615-studio-development-environment/plan.md` proposes a
  convention-driven Studio that owns no content or allowlist, one folder per model
  under `docs/game/model/<model>/`, one home per volatile record field in front
...
- decided / D1 Studio rendering: on 2026-08-17 the User chose Rust server-rendered
  ...
  scope: `src/studio/`, `web/`, Studio tests and the local Studio operation
...
- decided / D3 model folders: on 2026-08-17 the User accepted one folder per model
  under `docs/game/model/<model>/` with `README.md` as the contract entry — world,
  ...
  `docs/game/domain.md` remains as the overview and cross-model rules at a stable
  ...
  every new model must receive its own folder. Affected scope: `docs/game/`
...
- decided / D4 volatile-field home: on 2026-08-17 the User chose front matter as
  ...
  scope: `docs/concept/`, `docs/research/`, `docs/evidence/`, `lab/` indexes and
...
- decided / D5 backlog state home: on 2026-08-17 the User confirmed the horizon
  table in `.agents/backlog/README.md` as the single home for backlog order and
...
- decided / D7 Live boundary: on 2026-08-17 the User expanded Studio Live to
  ...
  and schema are unchanged. Affected scope: Studio Live reads, `src/server/http.rs`,
  `docs/game/README.md`, `docs/game/protocol.md`, `docs/game/local-play.md`.
- decided / D8 builder brief: on 2026-08-17 the User accepted one Markdown builder
  ...
  repository content. Affected scope: `src/studio/brief.rs`, one Rust binary and
  Cargo alias, `.agents/skills/build-aicadia/SKILL.md`.
...
- decided / Studio CSS approach: on 2026-08-17 the User chose one hand-written CSS
  ...
  `web/studio.css` and Studio templates.

## Studio development environment — plan accepted

- accepted: on 2026-08-17 the User accepted
  `.agents/plans/20260817-161615-studio-development-environment/plan.md` after
  ...
  `.agents/backlog/**` metadata, `lab/**` metadata, `src/studio/`, `web/`,
