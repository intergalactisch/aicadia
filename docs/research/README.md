...
| [Unified World change system](unified-world-change-system.md) | pending | August Activity-Property-Trait | Can one bounded Agent-authored change package unify Entity creation and change, deterministic concurrency, Activity, resource invalidation, scoped World effects and optional collective assembly at massive scale? |
