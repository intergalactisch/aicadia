...
> **Excludes:** Each report's own status and era, which live in its front matter; product decisions and current implementation contracts, which belong in `docs/game/`.
