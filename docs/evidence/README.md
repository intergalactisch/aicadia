...
> **Excludes:** Each slice's own current status, which lives in its front matter; game-contract rules, concept rationale and planning state; see `docs/game/`, `docs/concept/` and `.agents/`.
