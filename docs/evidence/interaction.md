...
> **Authority:** owns deterministic Pip-and-Mara World and adapter proof.
> **Excludes:** current Interaction semantics and paid-Action history; see `docs/game/` and `action.md`.
...
The paid trail-marker candidates remain exactly what they were: Agent evidence for
the former `submit_action` slice and the catalog published at their execution time.
They are not renamed as Interaction evidence. No paid model was invoked for the
Pip-and-Mara result.
